    ...
    <div className="w-full md:w-[908px] bg-[#F5F5F5] md:h-[244px] shrink-0 font-['Poppins']">
      <div className="flex flex-col gap-[16px] px-4 md:px-8 py-4 ">
        <div className="flex flex-wrap gap-[14px] items-start justify-between ">
          ...
          <div className="flex bg-white rounded-[28.017px] border-[#D9D9D9] border-solid border-[1px] items-center justify-center gap-[9.339px] py-2 px-6  md:py-[7px] md:px-[49px] text-[12px] md:text-[14px] font-medium">
            Order Details
          </div>
        </div>
